...
import ConfirmModal from "@/app/components/admin/posts/ConfirmModal";
...
export default function PostsManagement() {
  ...
  const getModalConfig = (action, post) => {
    const configs = {
      delete: {
        title: "Delete Post",
      ...
      approve: {
        title: "Approve Post",
        message: `Are you sure you want to approve the post "${post.title}"? This will make it visible to all users.`,
        action: "approve",
      },
      reject: {
        title: "Reject Post",
        message: `Are you sure you want to reject the post "${post.title}"?`,
        action: "reject",
      },
      feature: {
        title: "Feature Post",
        message: `Are you sure you want to feature the post "${post.title}" on the homepage?`,
        action: "default",
      },
      unfeature: {
        title: "Unfeature Post",
        message: `Are you sure you want to remove the post "${post.title}" from featured posts?`,
        action: "default",
      },
    };
    ...
    <div className="min-h-screen bg-gray-50 pb-16">
      ...
      <main className="">
            ...
            >
              <div className="flex-1">
                <div className="relative rounded-lg overflow-hidden shadow-sm">
                  ...
                  <input
                    type="text"
                    className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-12 py-3 border-gray-200 rounded-lg"
              ...
              <div className="flex space-x-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="block w-full pl-3 pr-10 py-2 text-base border-gray-200 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-lg appearance-none"
                  >
        ...
        <div className="mb-6 flex flex-wrap items-center gap-2">
          {filterStatus !== "all" && (
            <div className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-indigo-50 text-indigo-800 border border-indigo-100">
              Status:{" "}
        ...
        <ConfirmModal
          ...
          {...getModalConfig(modalAction, selectedPost || { title: "" })}
